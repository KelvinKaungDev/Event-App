...
struct EventList: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case id = "_id", name, description, units, date, startTime, endTime, location, isPending, isCompleted, isApproved, isRejected, isSuspended, isCancelled, organizerList, creatorId, createdAt, updatedAt
    }
}
